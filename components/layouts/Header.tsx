      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          ...
          <Link href="/" className="flex items-center space-x-1">
            <Image src="/images/logo.png" alt="한국산업인재육성학원" width={60} height={60} />
            <div className="flex flex-col">
              <span className="text-xl font-bold text-gray-900">한국산업인재육성학원</span>
              <span className="text-xs text-gray-600 px-0.5">대구 회계·세무·컴퓨터학원</span>
            </div>
          </Link>
          ...
          <div className="hidden lg:flex items-center space-x-4">
            ...
            >
              <Phone size={18} />
              <span className="font-semibold">053-818-5677</span>
            </Link>
            <Link
              href="#contact"
